...
export class DishHandler {
    ...
    filter(params: { page: PaginationParams, filter: DishesFilterParams }, cb: HandlerCallback<Partial<IDishModel>[]>) {
    ...
    getById(params: {id: string }, cb: HandlerCallback<Partial<IDishModel>>) {
